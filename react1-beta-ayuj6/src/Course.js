    ...
    return (
      ...
      <Accordion id="acc">
        ...
        <Accordion.Body>
          ...
          <p><h6><strong>Requisites: </strong> {this.getRequisites()}</h6></p>
          <p><h6><strong>Keywords: </strong>{curr.keywords.toString()}</h6></p>

          {(curr.sections.length > 0) ? <h5 id ="sec">Sections</h5> : null}
